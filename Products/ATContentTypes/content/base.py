...
class ATCTFileContent(ATCTContent):
    ...
    def _setATCTFileContent(self, value, **kwargs):
        ...
        if self._isIDAutoGenerated(self.getId()):
            ...
            if request_id and not self._isIDAutoGenerated(request_id):
                ...
                pass
            elif clean_filename and self._should_set_id_to_filename(clean_filename):
    ...
    def _should_set_id_to_filename(self, clean_filename):
        """Given the converted-to-ASCII name of the uploaded file, return whether it should be used as my ID."""
        raise NotImplementedError("_should_set_id_to_filename method must be implemented by subclasses.")
